...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir", default='runs/r2', type=str, help="dir to save finetuned model"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    dataset_dir = os.path.join('.', args.dataset_root)
    train_dataset ,eval_dataset= read_data(dataset_dir) 
